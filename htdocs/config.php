<?php
	...
	$config['quests'] = array(
		array(91000,4,"Catches",1),
		array(10200,1,"Lugia de Vermilion",0),
		array(10201,1,"Moltres de Cerulean",0),
		array(10202,1,"Articuno de Snow",0),
		array(10203,1,"Zapdos de Nostrus",0),
		array(10204,1,"Poison Stone Lavender",0),
		array(10205,1,"Punch Stone Nostrus",0)
	...
	*/
	...
	$config['available_towns'] = array(34);
	...
	$config['client_download'] = 'downloads/dashclient1.zip';
	...
	$config['gameserver'] = array(
		'ip' => '127.0.0.1',
		'port' => 7172,
		'name' => 'dash' // Must be identical to config.lua (OT config file) server name.
	);
	...
	*/
	$config['mailserver'] = array(
		...
		'username' => 'email', // Likely the same as email
	...
	$config['captcha_site_key'] = "6LeqjG4UAAAAAFpup_80Lyb4zImEtPwI-ps62xnx";
	$config['captcha_secret_key'] = "6LeqjG4UAAAAAOtSt6rx_vB9jOTvVGpw0k3Z0NYW";
	...
	*/
	...
	$config['pagseguro'] = array(
		...
		'token' => '825bdc8c-a1bc-42cb-a174-00c4a80a49162dda3fec4c20ae7f3920f4f70ccffa0ef252-4e45-4019-b979-acc7f4bf7b07',
		'currency' => 'BRL',
		'product_name' => 'VIP Points',
		'price' => 100, // 1 real
	...
	*/
	$config['shop_offers'] = array(
		1 => array(
			'type' => 1,
			'itemid' => 2145, // item to get in-game
			'count' => 1, // Stack number (5x itemid)
			'description' => "Diamond", // Description shown on website
